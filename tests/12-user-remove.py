...
class user_remove_test(test_tpl):
    ...
    def setUp(self):
        super().setUp()
        self.user_res = None
        self.subscribe_device('user/remove', self.on_evt)
        self.user_res = None
    ...
    def unknown_user_rm(self):
        ...
        self.user_res = None
        self.publish_device('user/remove', base64.b64encode(os.urandom(32)).decode('utf-8'), self.cfg.user_key)
    ...
    def known_user_rm(self):
        ...
        (usr_pos, user_id) = self.add_user('remove@known.user', '1')
        time.sleep(5)
        self.user_res = None
        ...
        self.assertTrue(usr_pos == self.user_res)
